...
const Index = () => {
  ...
  return (
    <div className="min-h-screen font-poppins relative galaxy-bg overflow-hidden">
      ...
      <div className="absolute top-60 right-[10%] w-24 h-24 emoji z-10 animate-float" style={{ animationDelay: '1.5s' }}>
        <div className="w-24 h-24 bg-[#F5DF4D] rounded-full flex items-center justify-center shadow-lg">
          <Sparkles className="w-14 h-14 text-white" />
        </div>
      </div>
      <div className="absolute bottom-32 left-[15%] w-16 h-16 emoji z-10 animate-float" style={{ animationDelay: '2s' }}>
        <div className="w-16 h-16 bg-[#3DFDFF] rounded-full flex items-center justify-center shadow-lg">
          <Brain className="w-8 h-8 text-white" />
        </div>
      </div>
      <div className="absolute bottom-80 right-[18%] w-18 h-18 emoji z-10 animate-float" style={{ animationDelay: '1s' }}>
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {audienceCards.map((card, index) => (
                <div 
                  key={card.title}
                  className="bg-white/20 backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-xl transform transition-all duration-300 hover:-translate-y-2"
                >
                  ...
                  <ul className="space-y-2">
                    {card.benefits.map((benefit, i) => (
                      <li key={i} className="flex items-center text-[#1A1F2C]/80">
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {testimonials.map((item, index) => (
                <div 
                  key={index}
                  className="bg-white/20 backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-xl relative"
                >
